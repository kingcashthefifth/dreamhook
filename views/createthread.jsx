    ...
    return (
      <html>
        ...
        <body>
          <nav className="navbar navbar-light bg-light sticky-top shadow-sm p-2 bg-light">
            ...
            <ul className="nav justify-content-end">
              <li className="nav-item">
                <a className="btn btn-outline-secondary active mr-2" href="/newthread">
                  New thread
                </a>
              </li>
              <li className="nav-item">
          ...
          <br />
          <h1 className="ml-5 p-3">Create a new thread</h1>
          <br />
          <div className="m-auto" style={{ width: "95%" }}>
            <form action="/createdthread" method="post">
              ...
              <div className="form-group">
                ...
                <textarea className="form-control" name="authorcontent" id="textareaform" rows="6"></textarea>
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      Do you wish to create this thread?
                    </div>
